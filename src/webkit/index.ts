                    ...
                    ${
                        faceItUserJSON
                            ...
                            <a target="_blank" class="nolink" href="https://www.faceit.com/en/players/${faceItUserJSON?.nickname ?? ''}" rel="noopener">
                                <img src="https://steamloopback.host/steamui/faceit_arrow.png" class="account-faceitinfo-container-arrow" alt="FaceIt profile arrow">
                            </a>
                            ...
                            <div class="account-faceit-level">
                                <a target="_blank" class="nolink" href="https://www.faceit.com/en/players/${faceItUserJSON?.nickname ?? ''}/stats/cs2" rel="noopener">
                                    <img src="https://steamloopback.host/steamui/skill_level_${faceItUserJSON?.skill_level ?? 0}_lg.png" alt="FaceIt level ${faceItUserJSON?.skill_level ?? 0} icon" width="48" height="48">
                                </a>
                            </div>
